<x-layouts.app>
    ...
    <section class="bg-search-section bg-cover bg-center">
        <div class="flex bg-black bg-opacity-60 py-36">
            <div class="container mx-auto flex flex-col space-y-12 justify-center text-white">
                <!-- Caption -->
                ...
                <!-- Search -->
                <div class="flex space-x-2 w-full 2xl:max-w-2xl mx-auto">
                    <div class="flex-grow">
                        <input
                    ...
                    <div class="flex-none">
                        <button class="h-16 w-20 text-xl bg-jh-green-400"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </div>
        </div>
